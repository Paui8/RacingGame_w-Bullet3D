...
update_status ModuleCamera3D::Update(float dt)
{
	...
	LookAt(vec3(CAMERA_X, +1, CAMERA_Z));
	...
	//	Position.x = App->player->vehicle->vehicle->getChassisWorldTransform().getOrigin().getX() + 10;
	//	Position.z = App->player->vehicle->vehicle->getChassisWorldTransform().getOrigin().getZ() + 10 * App->player->vehicle->vehicle->getForwardVector().getZ() - 100;
	//	Position.y = App->player->vehicle->vehicle->getChassisWorldTransform().getOrigin().getY() + 100 * App->player->vehicle->vehicle->getUpAxis();
	//}
